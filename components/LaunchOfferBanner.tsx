 ...
 * 24 Aug 2026 23:59 UTC - LAUNCH_OFFER_ENDS matches it so the banner
 * takes itself down when the code stops working.
 */
const LAUNCH_OFFER_ENDS = Date.UTC(2026, 7, 24, 23, 59, 59);
...
export function LaunchOfferBanner() {
  ...
  return (
    <Link
      href="/guides/bangkok"
      aria-label="Launch offer - the Bangkok guide free with code LAUNCH until 24 August"
